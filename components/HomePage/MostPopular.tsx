...
const MostPopular = async () => {
  return (
    <>
      ...
      <section className="my-14 mr-10 hidden w-1/4 min-w-60 max-w-80 flex-col items-center justify-center gap-8 place-self-end self-start text-neutral-700 dark:text-neutral-300 large-nav:flex">
