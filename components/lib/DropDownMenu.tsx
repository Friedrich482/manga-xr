...
>(({ menuPosition, className, ...props }, ref) => {
  return (
    <div
      className={tm(
        "absolute z-20 max-h-80 w-full overflow-y-scroll rounded-lg border border-neutral-800 bg-default-white py-2 pl-2 dark:bg-default-black max-options-menu-breakpoint-2:text-base",
