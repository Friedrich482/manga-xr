...
const ChaptersDropDown = ({ chapters }: { chapters: chapterType[] }) => {
  ...
  return (
    <div className="">
      <button
        ref={ref}
        className="flex items-center gap-x-1 rounded-lg border border-neutral-500/50 px-2 py-1 hover:border-neutral-500 max-options-menu-breakpoint-2:text-base options-menu-breakpoint-2:w-48 options-menu-breakpoint-2:justify-around options-menu-breakpoint-2:gap-x-3"
        onClick={() => {
